	...
	<td class="woocommerce-table__product-name product-name">
		...
		<div class="product-name__wrapper">
			<span class="product-thumbnail">
				<?php $thumbnail = $product->get_image('cart-thumbnail');
			...
			<span class="product-name"><?php echo wp_kses_post( apply_filters( 'woocommerce_order_item_name', $product_permalink ? sprintf( '<a href="%s">%s</a>', $product_permalink, $item->get_name() ) : $item->get_name(), $item, $is_visible ) ); ?></span>
